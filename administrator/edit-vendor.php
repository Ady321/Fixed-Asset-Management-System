													...
													<div class="step-pane active" data-step="1">
														...
														<form class="form-horizontal" id="validation-form" method="get">
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="supplierName">Supplier Name:</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="supplierName" name="supplierName" class="col-xs-12 col-sm-5" value="<?php echo $row['Name']; ?>" />
																	</div>
																</div>
															</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('#validation-form').validate({
					...
					messages: {
						supplierName: "Please provide the Supplier name",
