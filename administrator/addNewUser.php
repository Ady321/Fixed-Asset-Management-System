								...
								<div class="widget-box">
                                  ...
                                  <div class="form-group">
                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="Name">Name:</label>
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                                  <div class="clearfix">
                                                      <input type="text" id="Name" name="Name" class="col-xs-12 col-sm-5" value="" />
                                                 </div>
                                        </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">Email:</label>
                                          ...
                                          <div class="col-xs-12 col-sm-9">
                                              <div class="clearfix">
                                                  <input type="text" id="email" name="email" class="col-xs-12 col-sm-5" value="" />
                                              </div>
                                          </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="title">Title:</label>
                                          ...
                                          <div class="col-xs-12 col-sm-9">
                                              <div class="clearfix">
                                                 <input type="text" id="title" name="title" class="col-xs-12 col-sm-5" value="" />
                                              </div>
                                          </div>
                                  </div>
                                  <div class="form-group">
                                                 ...
                                                 <select name="team" class="col-xs-12 col-sm-5">
                                                     <option selected value="">--Select Team--</option>
                                                      <?php
                                                       ...
                                                       ?>
                                                                <option value="<?php echo $row2['dept_Id'] ?>"><?php echo $row2['Name'] ?></option>
                                                       <?php
                                                        }
                                                       ?>
                                                  </select>
                                  ...
                                  <div class="form-group">
                                      <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="mobno">Mobile No:</label>
                                          ...
                                          <div class="col-xs-12 col-sm-9">
                                              <div class="clearfix">
                                                 <input type="text" id="mobno" name="mobno" class="col-xs-12 col-sm-5" value="" />
                                              </div>
                                          </div>
                                  </div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
					bootbox.dialog({
						message: "Are you sure you want to create the new user?",
				...
				$('#edit-form').validate({
					...
					messages: {
						Name: "please provide the name",
                                                email: "please provide the email id",
                                                title: "plese provide the title",
                                                team: "please provide the team",
                                                mobno: "please provide the mobno"
					},
