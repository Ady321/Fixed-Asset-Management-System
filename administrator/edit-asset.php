  ...
  $pagetitle ="Edit asset";
	...
	$activeAddasset = "active";
        if(isset($_GET['id'])){
            ...
            $stmt_aq = mysqli_query($db,"select TagId,sub_Id,serial_no,sup_id,con_id,loc_id,asset_name,Id from asset where assetId='".$assetId."'");
            $row = mysqli_fetch_assoc($stmt_aq);
        }
 ?>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<select id="assetSupplier" name="assetSupplier" class="select2" data-placeholder="Click to Choose...">
																		...
																		<?php
																			$stmt12 = mysqli_query($db,"select sup_id,sup_Name from suppliers");
																			while($row_sup = mysqli_fetch_assoc($stmt12) )
																			{
