...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Forgot password - Asset Manager</title>
											       ...
											       $message.='font-weight: normal; padding-left: 36px; padding-right: 36px;" valign="top" align="left">';
											         ...
											         $message.='width: 378px;" valign="top" align="left">';
											           $message.='<div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">';
											             $message.='<a href = "http://localhost/wpams/reset-password?id='.$id.'&code='.$code.'" style="color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #6fb3e0; padding: 4px 9px; font-size: 15px; line-height: 21px; background-color: #6fb3e0;">&nbsp; Reset &nbsp;</a>';
											           $message.='</div>';
